...
load('simuFuzzy_PID_Modelo_3.mat')
load('simuFuzzy_1_Planta_pid_3.mat')


tempModelo;              % Model Temperature
tempPlanta = simuFuzzy_1_Planta_pid_3.tempPlanta; % Plant Temperature
setPoint;   % reference
uPlanta = simuFuzzy_1_Planta_pid_3.uPlanta;    % Controller action
